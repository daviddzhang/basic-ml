  ...
  return (
    <PageLayout>
      ...
      <p className="page-layout__content">
        ...
        this site came from a realization that I had forgotten most of what I had learned in the beginning of the course after finishing.
        ...
        <br /> <br />
        There isn't really a "correct" way to use the site. The modules are very much designed to be sandboxes that help visualize 
        the impact that various parameters, features, and training can have on a model. To get the most out of this site, an ideal 
        user would have some primary knowledge of the various topics presented here, but as per the site's name, all the ideas 
        are beginner-level. You could probably glean any requisite information from a blog post or wiki page found via a quick Google 
        search. 
        <br /> <br />
